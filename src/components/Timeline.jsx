              ...
              {timelineEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="absolute left-1/2 transform -translate-x-1/2 z-20">
                    <div
                      className={`w-6 h-6 rounded-full bg-gradient-to-r from-orange-400 to-amber-500 border-4 border-black shadow-lg shadow-orange-500/30 transition-all duration-500 ${
                        activeItem === index
                          ? "scale-150 shadow-orange-500/60"
                          : ""
                      }`}
                    ></div>
                  </div>
                  ...
                  <div
                    className={`flex ${
                      index % 2 === 0
                        ? "justify-start pr-4 md:pr-8"
                        : "justify-end pl-4 md:pl-8"
                    }`}
                  >
                    <div
                    ...
                    >
                      ...
                      >
                        <div
                          className={`backdrop-blur-xl bg-gradient-to-r from-brand-orange/90 to-brand-gold/90 border border-orange-300/50 rounded-full px-6 py-2 shadow-xl shadow-brand-orange/30 transition-all duration-500`}
                        >
                        ...
                        <div className="relative">
                          ...
                          <div className="backdrop-blur-2xl bg-black/40 border border-orange-400/20 rounded-3xl p-8 shadow-2xl shadow-orange-500/10">
                            ...
                            <div
                              ...
                              } w-20 h-20 bg-gradient-to-br from-brand-orange/10 to-brand-gold/10 ${
                                index % 2 === 0
                                  ? "rounded-bl-3xl"
                                  : "rounded-br-3xl"
                              } rounded-tr-3xl`}
                            ...
                            <div
                              ...
                              } w-16 h-16 bg-gradient-to-tr from-orange-400/10 to-amber-400/10 ${
                                index % 2 === 0
                                  ? "rounded-tr-3xl"
                                  : "rounded-tl-3xl"
                              } rounded-bl-3xl`}
                            ...
                            <div
                              className={`absolute inset-0 rounded-3xl bg-gradient-to-r from-orange-500/10 to-amber-500/10 blur-sm -z-10 transition-opacity duration-500 ${
                                activeItem === index
                                  ? "opacity-100"
                                  : "opacity-0"
                              }`}
                          ...
                          <div
                            className={`absolute top-1/2 ${
                              index % 2 === 0
                                ? "-right-8 md:-right-16"
                                : "-left-8 md:-left-16"
                            } w-8 md:w-16 h-0.5 bg-gradient-to-r from-orange-400 to-amber-500 transform -translate-y-1/2`}
                          >
                            <div
                              className={`absolute inset-0 bg-gradient-to-r from-orange-300 to-amber-300 rounded-full transition-all duration-1000 ${
                                visibleItems.has(index)
                                  ? "scale-x-100"
                                  : "scale-x-0"
                              } ${
